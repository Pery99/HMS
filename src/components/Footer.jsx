      ...
      <div className="max-w-7xl mx-auto pt-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <h3 className="text-3xl font-playfair font-bold text-white">LuxStay</h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['About Us', 'Our Rooms', 'Services', 'Contact', 'Gallery'].map(link => (
                <li key={link}>
                  <a href={`#${link.toLowerCase()}`} className="text-gray-300 hover:text-white transition-colors duration-300">
                    {link}
                  </a>
                </li>
              ))}
            ...
            <form className="space-y-4">
              <div className="flex">
                <input
                  ...
                  className="w-full px-4 py-2 rounded-l-md focus:outline-none focus:ring-2 focus:ring-secondary"
                />
                <button className="bg-secondary text-primary px-6 rounded-r-md hover:bg-opacity-90 transition duration-300">
                  Join
                </button>
              </div>
            </form>
