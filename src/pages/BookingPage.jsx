...
const BookingPage = () => {
  ...
  const renderRoomSelection = () => (
    <motion.div
      ...
      className="space-y-6"
    >
      <h3 className="text-2xl font-playfair font-semibold text-gray-800 mb-6">Select Your Room</h3>
      <div className="space-y-4">
        {roomTypes.map((room) => (
          <label
            key={room.type}
            className={`relative flex p-6 border rounded-xl cursor-pointer transition-all duration-200
              ${bookingData.roomType === room.type ? 'border-primary bg-primary/5' : 'border-gray-200'}
            `}
          >
            <input
              type="radio"
      ...
      <div className="relative z-10">
        ...
        <header className="pt-6 pb-12 px-4">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <h1 className="text-2xl font-playfair font-bold text-white">Book Your Stay</h1>
          </div>
        </header>
            ...
            {steps.map((s, i) => (
              <div key={s.number} className="flex-1 relative">
                <div className={`
                  ...
                  ${i !== steps.length - 1 ? 'after:content-[""] after:absolute after:w-full after:h-0.5 after:bg-gray-300 after:top-5 after:left-1/2 after:-z-10' : ''}
                `}>
                  <div className={`
                  ...
                  <span className={`mt-2 text-sm font-medium ${step >= s.number ? 'text-white' : 'text-gray-400'}`}>
                    {s.title}
                  </span>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-4 pb-20">
          ...
          >
            ...
            <div className="md:col-span-2 bg-white/95 backdrop-blur-md rounded-2xl shadow-xl p-8">
              ...
              {step === 3 && (
                <motion.div
                  ...
                  className="space-y-6"
                >
                  <h3 className="text-2xl font-playfair font-semibold text-gray-800 mb-6">Guest Information</h3>
                  <div className="grid grid-cols-2 gap-6">
                    <div>
              ...
              {step === 4 && (
                <motion.div
                  ...
                  className="space-y-8"
                >
                  <h3 className="text-2xl font-playfair font-semibold text-gray-800 mb-6">Review Your Booking</h3>
                  
                  <div className="space-y-6">
                    {/* Stay Details */}
                    <div className="bg-gray-50 p-6 rounded-lg">
                      <h4 className="text-lg font-semibold text-gray-800 mb-4">Stay Details</h4>
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="font-medium capitalize">{bookingData.roomType} Suite</p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-xl p-6 h-fit sticky top-8">
              <h3 className="text-xl font-playfair font-bold text-gray-900 mb-6">Booking Summary</h3>
              <div className="space-y-4">
